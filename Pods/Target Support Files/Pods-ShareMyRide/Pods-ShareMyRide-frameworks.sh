...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-ShareMyRide/Alamofire.framework"
  install_framework "Pods-ShareMyRide/Argo.framework"
  install_framework "Pods-ShareMyRide/Curry.framework"
